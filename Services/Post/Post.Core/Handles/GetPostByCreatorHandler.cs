...
{
    public class GetPostByCreatorHandler : IRequestHandler<GetPostByCreatorQuerry, IList<GetPostResponse>>
    {
        ...
        public async Task<IList<GetPostResponse>> Handle(GetPostByCreatorQuerry request, CancellationToken cancellationToken)
        {
